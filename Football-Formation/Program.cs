...
namespace FootballFormation
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            Player player4 = new Player("Inigo Martínez", 34, 182, CB, 10);
            Player player5 = new Player("Pau Cubarsí", 18, 184, CB, 60);
            ...
            Player player15 = new Player("Antonio Rudiger ", 32, 190, CB, 45);
            Player player16 = new Player("Eder Militao", 27, 186, CB, 35);
            ...
            new Player("Alisson Becker", 32, 193, GK, 15);
            new Player("Manuel Neuer", 39, 193, GK, 5);
            new Player("Gianluigi Donnarumma", 26, 196, GK, 70);
            new Player("Federico Dimarco", 27, 175, LB, 50);
            new Player("Trent Alexander-Arnold", 26, 175, RB, 65);
            new Player("Alejandro Grimaldo", 27, 171, LB, 55);
            new Player("Achraf Hakimi", 26, 181, RB, 80);
            new Player("Nico Schlotterbeck", 25, 191, CB, 60);
            new Player("Virgil van Dijk", 33, 195, CB, 45);
            new Player("Illya Zabarnyi", 22, 189, CB, 40);
            new Player("Ruben Dias", 28, 186, CB, 60);
            new Player("Joshua Kimmich", 30, 176, CM, 50);
            new Player("Stanislav Lobotka", 30, 170, CM, 35);
            new Player("N'Golo Kante", 34, 168, CM, 10);
            new Player("Hakan Çalhanoğlu", 31, 178, CM, 15);
            new Player("Kevin De Bruyne", 33, 181, CM, 10);
            new Player("Paulo Dybala", 31, 177, CM, 15);
            new Player("Neymar da Silva Santos Júnior", 33, 175, LW, 10);
            new Player("Rafael Leão", 26, 188, LW, 70);
            new Player("Khvicha Kvaratskhelia", 24, 183, LW, 110);
            new Player("Cristiano Ronaldo", 40, 189, ST, 5);
            new Player("Erling Braut Haaland", 24, 194, ST, 120);
            new Player("Mohamed Salah", 32, 175, RW, 60);
            new Player("Lionel Messi", 37, 169, RW, 5);
